...
if( isset( $_GET['listing_edit'] ) && is_numeric( $_GET['listing_edit'] ) ){
    ...
    $extra_price_per_guest          =   floatval   ( get_post_meta($edit_id, 'extra_price_per_guest', true) );
            ...
            $local_currency          =   esc_html   ( get_post_meta($edit_id, 'local_currency', true) );
    ...
    <div class="dashboard-margin">
        ...
        <div class="user_dashboard_panel">
            ...
            <?php
                ...
                if (isset($_GET['isnew']) && ($_GET['isnew']==1 ) ){
                    print ' <div class="col-md-12 new-listing-alert">'.esc_html__( 'Your listing is currently pending. Please complete all mandatory fields.','wprentals').'</div>';
                }
