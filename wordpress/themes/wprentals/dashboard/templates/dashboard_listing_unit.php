...
$duplicate_link             =   esc_url_raw ( add_query_arg( 'action', 'description', $edit_link) ) ;
...
$currency_title              =   esc_html   ( get_post_meta($post->ID, 'local_currency', true) );
