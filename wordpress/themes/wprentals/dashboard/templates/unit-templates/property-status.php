...
if($post_status=='expired'){
    ...
    $status='<div class="wprentals_status wprentals_status_'.esc_attr($post_status).'"><div class="wprentals_status_circle"></div>'.esc_html__( 'Editing','wprentals').'</div>';
}
