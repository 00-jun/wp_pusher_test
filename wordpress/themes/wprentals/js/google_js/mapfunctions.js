...
if (document.getElementById('mobile-geolocation-button')) {
    document.getElementById('mobile-geolocation-button').addEventListener('click', function () {
        "use strict";
        wprentals_myposition(map);
        wpestate_close_adv_search();
    });
...
if (document.getElementById('gmap')) {
    document.getElementById('gmap').addEventListener('mouseout', function () {
        "use strict";
        if(wprentals_map_type===1){
            map.setOptions({'scrollwheel': true});
        }
...
if (document.getElementById('search_map_button')) {
    document.getElementById('search_map_button').addEventListener('click', function () {
        "use strict";
        infoBox.close();
    });
}
...
if (document.getElementById('advanced_search_map_button')) {
    document.getElementById('advanced_search_map_button').addEventListener('click', function () {
        "use strict";
        infoBox.close();
    });
}
...
if (document.getElementById('gmap-menu')) {
    document.getElementById('gmap-menu').addEventListener('click', function (event) {
        "use strict";
        var category;
        infoBox.close();
