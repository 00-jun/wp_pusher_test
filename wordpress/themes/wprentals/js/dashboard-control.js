/*global $, jQuery, ajaxcalls_vars, document, control_vars, window, map, setTimeout, Modernizr, wpestate_create_review_action, wpestate_create_payment_action, wpestate_invoice_create_js, wpestate_booking_cretupm_paypal, location, google, dashboard_vars, options, wpestate_create_delete_invoice_action, wpestate_create_generate_invoice_action,wpestate_booking_request_submit*/
...
<div class="extra_detail_option  col-md-4"><input type="text"class=" extra_option_value form-control" value="' +
  ...
  jQuery('#add_extra_option').on('click', function (event) {
    var option_name, option_value, option_type, to_add, select_name, option_checkin, option_checkout;
    jQuery('.no_extra_pay_option').remove();

    option_name = jQuery('#add_option_name').val();
    option_value = jQuery('#add_option_value').val();
    option_type = jQuery('#add_option_type').val();

    // 2023/3/11 デイユース開発 高橋（追加）
    option_checkin = jQuery('#add_option_checkin').val();
    option_checkout = jQuery('#add_option_checkout').val();
    ...
    to_add =
      ...
      '">\n\
      ' +
      wpestate_generate_checkin_out_dropdown('in', option_checkin) +
      '<span class="hyphen_for_time"> - </span>' +
      wpestate_generate_checkin_out_dropdown('out', option_checkout) +
      '</div>';

    jQuery('#add_option_name').val('');
    jQuery('#add_option_value').val('');
    // 2023/3/11 デイユース開発 高橋（追加）
    jQuery('#add_option_checkin').val('-1');
    jQuery('#add_option_checkout').val('-1');
    //        jQuery('#add_option_type').val('');

    jQuery('.extra_pay_option_wrapper').append(to_add);
  });

  // 2023/3/11 デイユース開発 高橋（追加）
  function wpestate_generate_checkin_out_dropdown(is_in_out, selected_time) {
    var time_select, add_class, time_0, time_1, time_2, time_3, time_4, time_5, time_6, time_7, time_8, time_9, time_10, time_11, time_12, time_13, time_14, time_15, time_16, time_17, time_18, time_19, time_20, time_21, time_22, time_23, time_24;
    if (is_in_out == 'in') {
      time_select = dashboard_vars.select_checkin;
      add_class = 'extra_option_checkin';
    } else {
      time_select = dashboard_vars.select_checkout;
      add_class = 'extra_option_checkout';
    }
    // time_0 = '';
    // time_1 = '';
    // time_2 = '';
    ...
    //   time_2 = ' selected ';
    // } else if (selected_time === 3) {
    //   time_3 = ' selected ';
    // } else if (selected_time === 4) {
    //   time_4 = ' selected ';
    // } else if (selected_time === 5) {
    //   time_5 = ' selected ';
    if (selected_time === 6) {
      time_6 = ' selected ';
    } else if (selected_time === 7) {
      time_7 = ' selected ';
    } else if (selected_time === 8) {
      time_8 = ' selected ';
    } else if (selected_time === 9) {
      time_9 = ' selected ';
    } else if (selected_time === 10) {
      time_10 = ' selected ';
    } else if (selected_time === 11) {
      time_11 = ' selected ';
    } else if (selected_time === 12) {
      time_12 = ' selected ';
    } else if (selected_time === 13) {
      time_13 = ' selected ';
    } else if (selected_time === 14) {
      time_14 = ' selected ';
    } else if (selected_time === 15) {
      time_15 = ' selected ';
    } else if (selected_time === 16) {
      time_16 = ' selected ';
    } else if (selected_time === 17) {
      time_17 = ' selected ';
    } else if (selected_time === 18) {
      time_18 = ' selected ';
    } else if (selected_time === 19) {
      time_19 = ' selected ';
    } else if (selected_time === 20) {
      time_20 = ' selected ';
    } else if (selected_time === 21) {
      time_21 = ' selected ';
    } else if (selected_time === 22) {
      time_22 = ' selected ';
    } else if (selected_time === 23) {
      time_23 = ' selected ';
    } else if (selected_time === 24) {
      time_24 = ' selected ';
    }

    return (
      '<select class="add_option_input ' +
      add_class +
      ' form-control">\n\
    <option value="-1">' +
      time_select +
      ...
      //   time_0 +
      //   ' >' +
      //   dashboard_vars.time_option_0 +
      //   '</option>\n\
      // <option value="1" ' +
      //   time_1 +
      //   ' >' +
      //   dashboard_vars.time_option_1 +
      //   '</option>\n\
      // <option value="2" ' +
      //   time_2 +
      //   ' >' +
      //   dashboard_vars.time_option_2 +
      //   '</option>\n\
      // <option value="3" ' +
      //   time_3 +
      //   ' >' +
      //   dashboard_vars.time_option_3 +
      //   '</option>\n\
      // <option value="4" ' +
      //   time_4 +
      //   ' >' +
      //   dashboard_vars.time_option_4 +
      //   '</option>\n\
      // <option value="5" ' +
      //   time_5 +
      //   ' >' +
      //   dashboard_vars.time_option_5 +
      //   '</option>\n\
      '<option value="6" ' +
      time_6 +
      ' >' +
      dashboard_vars.time_option_6 +
      '</option>\n\
    <option value="7" ' +
      time_7 +
      ' >' +
      dashboard_vars.time_option_7 +
      '</option>\n\
    <option value="8" ' +
      time_8 +
      ' >' +
      dashboard_vars.time_option_8 +
      '</option>\n\
    <option value="9" ' +
      time_9 +
      ' >' +
      dashboard_vars.time_option_9 +
      '</option>\n\
    <option value="10" ' +
      time_10 +
      ' >' +
      dashboard_vars.time_option_10 +
      '</option>\n\
    <option value="11" ' +
      time_11 +
      ' >' +
      dashboard_vars.time_option_11 +
      '</option>\n\
    <option value="12" ' +
      time_12 +
      ' >' +
      dashboard_vars.time_option_12 +
      '</option>\n\
    <option value="13" ' +
      time_13 +
      ' >' +
      dashboard_vars.time_option_13 +
      '</option>\n\
    <option value="14" ' +
      time_14 +
      ' >' +
      dashboard_vars.time_option_14 +
      '</option>\n\
    <option value="15" ' +
      time_15 +
      ' >' +
      dashboard_vars.time_option_15 +
      '</option>\n\
    <option value="16" ' +
      time_16 +
      ' >' +
      dashboard_vars.time_option_16 +
      '</option>\n\
    <option value="17" ' +
      time_17 +
      ' >' +
      dashboard_vars.time_option_17 +
      '</option>\n\
    <option value="18" ' +
      time_18 +
      ' >' +
      dashboard_vars.time_option_18 +
      '</option>\n\
    <option value="19" ' +
      time_19 +
      ' >' +
      dashboard_vars.time_option_19 +
      '</option>\n\
    <option value="20" ' +
      time_20 +
      ' >' +
      dashboard_vars.time_option_20 +
      '</option>\n\
    <option value="21" ' +
      time_21 +
      ' >' +
      dashboard_vars.time_option_21 +
      '</option>\n\
    <option value="22" ' +
      time_22 +
      ' >' +
      dashboard_vars.time_option_22 +
      '</option>\n\
    <option value="23" ' +
      time_23 +
      ' >' +
      dashboard_vars.time_option_23 +
      '</option>\n\
      <option value="24" ' +
      time_24 +
      ' >' +
      dashboard_vars.time_option_24 +
      '</option>\n\
    </select>'
    );
  }
  ...
  $('.trip_details').on('click', function () {
    var invoice_id, booking_id, ajaxurl, acesta, parent, is_japanese;
  ...
  /// Complete bookings
  ///////////////////////////////////////////////////////////////////////////////////////
  $('.complete_booking').on('click', function () {
    if (confirm(dashboard_vars.complete_mess)) {
      var booking_id, ajaxurl, acesta, listing_id;
      booking_id = $(this).attr('data-booking-confirmed');
      listing_id = $(this).attr('data-listing-id');
      ajaxurl = control_vars.admin_url + 'admin-ajax.php';
      ...
      $(this).empty().html(dashboard_vars.processing);
      $('.create_invoice_form').hide();
      var nonce = jQuery('#wprentals_booking_confirmed_actions').val();
      ...
      $.ajax({
        ...
        url: ajaxurl,
        data: {
          action: 'wpestate_complete_booking',
          booking_id: booking_id,
          listing_id: listing_id,
          security: nonce,
        },
        success: function (data) {
          acesta.empty().html(dashboard_vars.completed);
          location.reload();
        },
        error: function (errorThrown) {},
      });
  ...
  ///////////////////////////////////////////////////////////////////////////////////////
  /// cancel user booking by user
  ///////////////////////////////////////////////////////////////////////////////////////
  $('.cancel_user_booking_by_user').on('click', function () {
    if (confirm(dashboard_vars.cancel_mess)) {
      var booking_id, ajaxurl, acesta, listing_id;
      booking_id = $(this).attr('data-booking-confirmed');
      listing_id = $(this).attr('data-listing-id');
      ...
      $.ajax({
        ...
        url: ajaxurl,
        data: {
          action: 'wpestate_cancel_booking_by_user',
          booking_id: booking_id,
          listing_id: listing_id,
          security: nonce,
        },
  ...
  //       url: ajaxurl,
  //       data: {
  //         action: 'wpestate_owner_cancel_own_booking',
  //         booking_id: booking_id,
  //         listing_id: listing_id,
  //       },
  //       success: function (data) {
  //         var count_acesta = acesta.length;
  //         if (count_acesta == 1) {
  //           acesta.parent().hide();
  //         }
  //         acesta.remove();
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          ...
          acesta
            ...
            .after('<span class="generate_invoice" data-bookid="' + book_id + '">' + dashboard_vars.issue_inv1 + '</span>');
  ...
  function wpestate_recreate_invoice_manual_expenses(butonul) {
    ...
    if (ex_name !== '' && ex_value !== '' && ex_name !== 0 && ex_value !== 0 && !isNaN(ex_value)) {
      ...
      if (dashboard_vars.where_currency_symbol === 'before') {
        ...
        jQuery('#total_amm')
          .empty()
          .append(dashboard_vars.currency_symbol + ' ' + total_amm);
        ...
        jQuery('#erarly_bird_row')
          .empty()
          .html(dashboard_vars.currency_symbol + '<span class="inv_data_value" data-clearprice="' + early_bird + '"> ' + early_bird + '</span> ');
      } else {
        jQuery('#inv_depozit')
          .empty()
        ...
        jQuery('#erarly_bird_row')
          .empty()
          .html('<span class="inv_data_value" data-clearprice="' + early_bird + '"> ' + early_bird + '</span> ' + dashboard_vars.currency_symbol);
      }
    }
  }
    ...
    jQuery.ajax({
      ...
      success: function (data) {
        if (data == 0) {
          ...
          // jQuery('#already_filled_modal .modalWrapper').html(data);
          jQuery('#instant_booking_modal').modal('hide');
          jQuery('#already_filled_modal').modal({
            backdrop: 'static',
            keyboard: false,
          });
        }
...
function wpestate_booking_request_submit() {
  // jQuery(document).on('click', '#booking_request_submit', function () {
  jQuery('#booking_request_submit').on('click', function () {
    var ajaxurl, fromdate, todate, listing_edit, comment, bookid, booking_guest_no, booking_adults, booking_childs, booking_infants, extra_options;
    ajaxurl = control_vars.admin_url + 'admin-ajax.php';

    fromdate = jQuery('#start_date').val();
    todate = jQuery('#end_date').val();

    fromdate = String(moment(fromdate).format('YYYY-MM-DD'));
    todate = String(moment(todate).format('YYYY-MM-DD'));

    listing_edit = jQuery('#listing_edit').val();
    comment = jQuery('#book_notes').val();
    booking_guest_no = jQuery('#booking_guest_no_wrapper').attr('data-value');

    booking_adults = booking_guest_no;
    booking_childs = 0;
    booking_infants = 0;
    ...
    var plan_booking = jQuery('.cost_row.plan_booking');
    var pb = [];
    plan_booking.each(function () {
      var plan_label = jQuery(this).find('.cost_explanation').text();
      var plan_price = jQuery(this).find('.cost_value').text();
      pb.push(plan_label + '/' + plan_price);
    });
    var nonce = jQuery('#wprentals_booking_request_submit').val();
    var plan = [];
    if (pb) {
      var plan = pb;
    }
    ...
    jQuery.ajax({
      ...
      url: ajaxurl,
      data: {
        action: 'wpestate_ajax_add_booking_request',
        fromdate: fromdate,
        plan: plan,
        todate: todate,
      ...
      success: function (data) {
        ...
        // 2023/7/5 デイユース開発 高橋（修正）---
        window.open(control_vars.booking_complete_url + '?param=' + data, '_self', false);
      },
      error: function (errorThrown) {},
    });
  });
