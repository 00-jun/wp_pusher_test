...
<div class="col-md-10 agentpic-wrapper">
    ...
    <?php 
        if($link!=''){?>
            <a class="owner_read_more " href="<?php print esc_url($link);?>">
            <?php
                // 2023/2/2 デイユース開発 高橋（修正）
                //  esc_html_e('See Owner Profile','wprentals');
                 esc_html_e('See accommodation profile','wprentals');
            ?>
            </a>
    <?php 
        } 
