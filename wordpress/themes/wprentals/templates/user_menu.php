...
<div class="user_tab_menu col-md-3" id="user_tab_menu_container">
    ...
    <div class="user_dashboard_links">
        ...
        <?php if( $dash_my_bookings!=$home_url && $dash_my_bookings!=""  && wpestate_check_user_level()){ ?>
            <a href="<?php print esc_url($dash_my_bookings);?>" class="<?php print esc_attr($activemybookins); ?>"><i class="far fa-folder-open"></i> <?php esc_html_e('Reservations','wprentals');?></a>
        <?php } ?>
        <?php if( $dash_my_reservations!=$home_url  && $dash_my_reservations!="" && !wpestate_check_user_level()){ ?>
            <a href="<?php print esc_url($dash_my_reservations);?>" class="<?php print esc_attr($activemyreservations); ?>"><i class="fas fa-folder-open"></i> <?php esc_html_e('Reservations','wprentals');?></a>
        <?php } ?>
        ...
        <?php if( wpestate_check_user_level()){ ?>
            <a href="<?php print esc_url($owners_manual);?>" ><i class="fas fa-book"></i> <?php esc_html_e('Listing Manual','wprentals');?></a>
        <?php } ?>
        ...
        <a href="<?php echo wp_logout_url(wpestate_wpml_logout_url());?>" title="Logout"><i class="icofont-logout"></i></i> <?php esc_html_e('Log Out','wprentals');?></a>
    </div>
</div>
