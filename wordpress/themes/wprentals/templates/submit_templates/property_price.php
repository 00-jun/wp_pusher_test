...
$currency_iso_code=array(
    '0'  =>esc_html__('-- Select local currency --','wprentals'),
    'AED'=>esc_html__('AED','wprentals'),
    'ARS'=>esc_html__('ARS','wprentals'),
    'AUD'=>esc_html__('AUD','wprentals'),
    'BGN'=>esc_html__('BGN','wprentals'),
    'BOB'=>esc_html__('BOB','wprentals'),
    'BRL'=>esc_html__('BRL','wprentals'),
    'BYN'=>esc_html__('BYN','wprentals'),
    'CAD'=>esc_html__('CAD','wprentals'),
    'CHF'=>esc_html__('CHF','wprentals'),
    'CLP'=>esc_html__('CLP','wprentals'),
    'CNY'=>esc_html__('CNY','wprentals'),
    'COP'=>esc_html__('COP','wprentals'),
    'CRC'=>esc_html__('CRC','wprentals'),
    'CZK'=>esc_html__('CZK','wprentals'),
    'DKK'=>esc_html__('DKK','wprentals'),
    'DOP'=>esc_html__('DOP','wprentals'),
    'EEK'=>esc_html__('EEK','wprentals'),
    'EUR'=>esc_html__('EUR','wprentals'),
    'GBP'=>esc_html__('GBP','wprentals'),
    'GEL'=>esc_html__('GEL','wprentals'),
    'GTQ'=>esc_html__('GTQ','wprentals'),
    'HKD'=>esc_html__('HKD','wprentals'),
    'HNL'=>esc_html__('HNL','wprentals'),
    'HRK'=>esc_html__('HRK','wprentals'),
    'HUF'=>esc_html__('HUF','wprentals'),
    'IDR'=>esc_html__('IDR','wprentals'),
    'ILS'=>esc_html__('ILS','wprentals'),
    'INR'=>esc_html__('INR','wprentals'),
    'ISK'=>esc_html__('ISK','wprentals'),
    'JMD'=>esc_html__('JMD','wprentals'),
    'JPY'=>esc_html__('JPY','wprentals'),
    'KRW'=>esc_html__('KRW','wprentals'),
    'KZT'=>esc_html__('KZT','wprentals'),
    'LKR'=>esc_html__('LKR','wprentals'),
    'LTL'=>esc_html__('LTL','wprentals'),
    'LVL'=>esc_html__('LVL','wprentals'),
    'MAD'=>esc_html__('MAD','wprentals'),
    'MDL'=>esc_html__('MDL','wprentals'),
    'MGA'=>esc_html__('MGA','wprentals'),
    'MKD'=>esc_html__('MKD','wprentals'),
    'MUR'=>esc_html__('MUR','wprentals'),
    'MVR'=>esc_html__('MVR','wprentals'),
    'MXN'=>esc_html__('MXN','wprentals'),
    'MYR'=>esc_html__('MYR','wprentals'),
    'NIO'=>esc_html__('NIO','wprentals'),
    'NOK'=>esc_html__('NOK','wprentals'),
    'NZD'=>esc_html__('NZD','wprentals'),
    'PEN'=>esc_html__('PEN','wprentals'),
    'PHP'=>esc_html__('PHP','wprentals'),
    'PKR'=>esc_html__('PKR','wprentals'),
    'PLN'=>esc_html__('PLN','wprentals'),
    'RON'=>esc_html__('RON','wprentals'),
    'RSD'=>esc_html__('RSD','wprentals'),
    'RUB'=>esc_html__('RUB','wprentals'),
    'SAR'=>esc_html__('SAR','wprentals'),
    'SCR'=>esc_html__('SCR','wprentals'),
    'SEK'=>esc_html__('SEK','wprentals'),
    'SGD'=>esc_html__('SGD','wprentals'),
    'SVC'=>esc_html__('SVC','wprentals'),
    'THB'=>esc_html__('THB','wprentals'),
    'TND'=>esc_html__('TND','wprentals'),
    'TRY'=>esc_html__('TRY','wprentals'),
    'TWD'=>esc_html__('TWD','wprentals'),
    'UAH'=>esc_html__('UAH','wprentals'),
    'UGX'=>esc_html__('UGX','wprentals'),
    'USD'=>esc_html__('USD','wprentals'),
    'UYU'=>esc_html__('UYU','wprentals'),
    'VEF'=>esc_html__('VEF','wprentals'),
    'VND'=>esc_html__('VND','wprentals'),
    'XAF'=>esc_html__('XAF','wprentals'),
    'XCD'=>esc_html__('XCD','wprentals'),
    'XOF'=>esc_html__('XOF','wprentals'),
    'XPF'=>esc_html__('XPF','wprentals'),
    'ZAR'=>esc_html__('ZAR','wprentals'),
    'ZMW'=>esc_html__('ZMW','wprentals')    
);

$checkin_out_time=array(
    '-1'  =>esc_html__('Select','wprentals'),
    ...
    function    wpestate_draw_month_price($edit_id,$property_price,$price_per_guest_from_one,$extra_price_per_guest,$month_no,$custom_price_array,$mega_details, $unixmonth, $daywithpost,$thismonth,$thisyear,$last_day){
        ...
        for ( $day = 1; $day <= $daysinmonth; ++$day ) {
            ...
            if( $setup_weekend_status ==0 && ($weekday ==6 || $weekday==7) ){
                $calendar_output.=wpestate_draw_weekend_day($edit_id,$timestamp_java,$mega_details,$property_price_week,$custom_price_array,$property_price,$price_per_guest_from_one,$extra_price_per_guest);
               ...
               // days during the week
                if( array_key_exists  ($timestamp_java,$custom_price_array) ){
                    // custom price
                    $calendar_output .= '<span class="custom_set_price">'.wpestate_show_price_custom ($edit_id,wpestate_display_price_simple($custom_price_array[$timestamp_java],$price_per_guest_from_one,$extra_price_per_guest)   ).'</span>';
                    ...
                    $calendar_output .= '<span class="custom_set_price">'.wpestate_show_price_custom ( $edit_id,wpestate_display_price_simple( $property_price,$price_per_guest_from_one,$extra_price_per_guest_custom )  ).'</span>';
                }else{
                    // default price
                    $calendar_output .= '<span class="price-day">'.wpestate_show_price_custom ( $edit_id,wpestate_display_price_simple($property_price,$price_per_guest_from_one,$extra_price_per_guest) ).'</span>';
                }
...
if( !function_exists('wpestate_draw_weekend_day')):
    function wpestate_draw_weekend_day($edit_id,$timestamp_java,$mega_details,$property_price_week,$custom_price_array,$property_price,$price_per_guest_from_one,$extra_price_per_guest){
    $calendar_output='';
    // WEEKEND days
    if(( array_key_exists ($timestamp_java,$mega_details)) ){
        ...
        $calendar_output .= '<span class="custom_set_price weekend_set_price">'.wpestate_show_price_custom ( $edit_id, wpestate_display_price_simple($property_price_week_custom  ,$price_per_guest_from_one,$extra_price_per_guest_custom) ).'</span>';
    }else if( $property_price_week!=0 ){
        // we have general price per weekend
        $calendar_output .= '<span class="custom_set_price weekend_set_price">'.wpestate_show_price_custom ( $edit_id, wpestate_display_price_simple($property_price_week ,$price_per_guest_from_one,$extra_price_per_guest) ).'</span>';
        ...
        if( array_key_exists  ($timestamp_java,$custom_price_array) ){
            $calendar_output .= wpestate_show_price_custom ( $edit_id, wpestate_display_price_simple($custom_price_array[$timestamp_java] ,$price_per_guest_from_one,$extra_price_per_guest) );
        }else{
            $calendar_output .= wpestate_show_price_custom ($edit_id,  wpestate_display_price_simple($property_price,$price_per_guest_from_one,$extra_price_per_guest) );
        }
...
<div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="col-md-3 dashboard_chapter_label">
                ...
                <!-- // 2023/3/11 デイユース開発 高橋（追加） -->
                    <?php esc_html_e('Local Currency ','wprentals');?>
                </label>
            </div>
            <div class="col-md-3">
                <label><span class="dashboard_red">*</span><?php esc_html_e('Local Currency ','wprentals'); ?></label>
                <select name="local_currency" id="local_currency" class="form-control">

                <?php
                    foreach($currency_iso_code as $key=>$value){
                        if($value==$local_currency){
                            print '   <option value="'.esc_attr($key).'" selected>'.esc_html($value).'</option>';
                        }else{
                ...
                <!-- <input type="text" id="local_currency" size="40" class="form-control"  name="city_fee" value="<?php print esc_html($city_fee);?>"> -->
            </div>
        </div>
        ...
        <div class="col-md-12">
           <div class="col-md-3 dashboard_chapter_label">
            ...
            <div class="col-md-3">
                ...
                <div class = "dashboard_price_recommend" >
                    <label for="property_price" ><?php esc_html_e('Please enter the amount of the plan you want to recommend the most.','wprentals'); ?> <label>
                </div>
                <input type="text" id="property_price" class="form-control" size="40" name="property_price" value="<?php print esc_html($property_price);?>">
            </div>
            <!-- /2023/2/16 デイユース開発 清水（追加）----->
            <div class="col-md-3 recommend_plan_detail_area">
                <p class="recommend_plan_text"><?php esc_html_e('★The amount of the plan you want to recommend is displayed in the list on the TOP screen.','wprentals'); ?></p>
                <div class="recommend_plan_image"><img src="/wp-content/themes/wprentals/img/add_new_listing/recommend_price.png" alt=""></div>
            </div>
    ...
    ?>
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <label for="property_taxes"> <?php esc_html_e('Value(only numbers)','wprentals'); ?>  </label>
    ...
    ?>
        <div class="col-md-12">
            <div class="col-md-3 dashboard_chapter_label">
            <!-- 2023/3/3 デイユース開発 高橋（修正）--->
                <label for="city_fee"><?php esc_html_e('City Fee in ','wprentals'); esc_html_e(' (only numbers)','wprentals'); ?></label>
            </div>
            <div class="col-md-3">
                <label for="city_fee"><?php esc_html_e('City Fee in ','wprentals'); esc_html_e(' (only numbers)','wprentals'); ?></label>
...
<!--         <div class="col-md-12">
    ...
    ?>
        <div class="col-md-12">
            ...
            <div class="col-md-3 dashboard_chapter_label">
                <label>
                    <?php esc_html_e('Plans','wprentals');?>
                </label>
            </div>
            <div class="col-md-6 plan_contents_area">
                <label><span class="dashboard_red">*</span><?php esc_html_e('Plans','wprentals');?></label>
                <!-- 2023/2/1 デイユース開発 高橋（追加）----->
                <div class = "dashboard_plans" >
                        <!-- ▼2023/2/16 デイユース開発 清水（追加） -->
                        <label for="property_plans" ><?php esc_html_e('You can register multiple plans by pressing the "Add Plan" button.','wprentals'); ?> <label>
                        <label for="property_plans" ><?php esc_html_e('ex) Evening plan: 14:00〜19:00','wprentals'); ?> <label>
                </div>
                <div class="extra_pay_option_wrapper">
                    ...
                    if(is_array($extra_pay_options)){
                        foreach($extra_pay_options as $key=>$wpestate_options){
                            print'<div class="extra_pay_option">';
                                ...
                                // 2023/3/11 デイユース開発 高橋（追加）---
                                print '<select class="add_option_input extra_option_checkin form-control">'  ;
                                foreach($checkin_out_time as $time_key=>$time){
                                    if($time_key=='-1'){
                                        print '   <option value="'.esc_attr($time_key).'">'.esc_html__('Select check-in time','wprentals').'</option>';
                                    }else{
                                        if($time_key==$wpestate_options[3]){
                                            print '   <option value="'.esc_attr($time_key).'" selected>'.esc_html($time).'</option>';
                                        }else{
                                            print '   <option value="'.esc_attr($time_key).'">'.esc_html($time).'</option>';
                                        }
                                    }
                                }
                                print '</select>';
                                print '<span class="hyphen_for_time"> - </span>';
                                print '<select  class="add_option_input extra_option_checkout form-control">'  ;
                                foreach($checkin_out_time as $time_key=>$time){
                                    if($time_key=='-1'){
                                        print '   <option value="'.esc_attr($key).'">'.esc_html__('Select check-out time','wprentals').'</option>';
                                    }else{
                                        if($time_key==$wpestate_options[4]){
                                            print '   <option value="'.esc_attr($time_key).'" selected>'.esc_html($time).'</option>';
                                        }else{
                                            print '   <option value="'.esc_attr($time_key).'">'.esc_html($time).'</option>';
                                        }
                    ...
                    // 2023/3/1 デイユース開発 清水（追加）---
                    print '<div>'.esc_html__('If you want to register multiple plans for the same room, please add them here.','wprentals').'</div>';
                    ...
                    // 2023/3/11 デイユース開発 高橋（追加）---
                    print '<select id="add_option_checkin" name="add_option_checkin" class="add_option_input  form-control">'  ;
                    foreach($checkin_out_time as $time_key=>$time){
                        if($time_key=='-1'){
                            print '   <option value="'.esc_attr($time_key).'">'.esc_html('check-in time').'</option>';
                        }else{
                            print '   <option value="'.esc_attr($time_key).'">'.esc_html($time).'</option>';
                        }
                    }
                    print '</select>';
                    print '<span class="hyphen_for_time"> - </span>';
                    print '<select id="add_option_checkout" name="add_option_checkout" class="add_option_input  form-control">'  ;
                    foreach($checkin_out_time as $time_key=>$time){
                        if($time_key=='-1'){
                            print '   <option value="'.esc_attr($time_key).'">'.esc_html('check-out time').'</option>';
                        }else{
                            print '   <option value="'.esc_attr($time_key).'">'.esc_html($time).'</option>';
                        }
                    }
                    ...
                    print '<span id="add_extra_option">'.esc_html__('Add Plan','wprentals').'</span>';
                print'</div>';
