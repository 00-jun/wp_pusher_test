...
?> 
    <div id="user_menu_open"> 
        ...
        if($home_url!=$dash_bookings && wpestate_check_user_level() ){?>
            <a href="<?php print esc_url($dash_bookings);?>" class="active_fav"><i class="far fa-folder-open"></i><?php esc_html_e('Reservations','wprentals');?></a>
        <?php   
        }

        if($home_url!=$dash_reservation && !wpestate_check_user_level() ){?>
        ...
        <a href="<?php echo wp_logout_url(wpestate_wpml_logout_url());?>" title="Logout" class="menulogout"><i class="icofont-logout"></i><?php esc_html_e('Log Out','wprentals');?></a>
    </div>
