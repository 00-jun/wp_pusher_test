            ...
            <div class="invoice_table">
                ...
                <div class="invoice_details">
                    ...
                    print'
                        ...
                        $label  =   esc_html__( 'Confirm Booking Request','wprentals');
            ...
            if( !is_numeric($_POST['listing_edit'] ) ){
                ...
                if( $current_user->ID != $the_post->post_author ) {
                    ...
                    if($status=='pending'){
                        ...
                        echo json_encode(array('edited'=>true, 'mobing'=>$moving_array,'response'=>esc_html__( 'Now published !','wprentals')));
                    }
            ...
            if( !is_numeric($_POST['listing_edit'] ) ){
                ...
                if( $current_user->ID != $the_post->post_author ) {
                    ...
                    if($status=='pending'){
                        ...
                        echo json_encode(array('edited'=>true,'room_id'=>$room_id,'room_empty'=>$room_empty,'beds_options'=>count($beds_options),'response'=>esc_html__( 'Now published !','wprentals')));
                    }
            ...
            if( !is_numeric($_POST['listing_edit'] ) ){
                ...
                if( $current_user->ID != $the_post->post_author ) {
                    ...
                    if($status=='pending'){
                        ...
                        echo json_encode(array('edited'=>true,'attach_array'=>$attach_array , 'response'=>esc_html__( 'Now published !','wprentals')));
                    }
