<div class="user_dashboard_panel">
    ...
    <!-- 2023/3/2 デイユース開発 清水（追加）----->
    <div class="col-md-12" id="profile_pass">
         <?php esc_html_e('*If you forget your password, log out from the site, open the login screen again, and open Forgot your password?','wprentals'); ?>
    </div>
