...
?>
    ...
    <div class="info-container">
        ...
        <a  data-original-title="<?php esc_attr_e('Duplicate property','wprentals');?>" class="dashboad-tooltip duplicate-property" data-propertyid="<?=$post_id;?>" href="<?php print esc_url($duplicate_link);?>"><i class="fas fa-copy"></i></a>
