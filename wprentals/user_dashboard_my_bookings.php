    ...
    <div class=" dashboard-margin">
        ...
        <div class="row dashboard_property_list user_dashboard_panel">
          ...
          <div class="wpestate_dashboard_table_list_header my_booking_header row">
            <div class="col-md-4"><?php esc_html_e('Property','wprentals'); ?></div>
            <div class="col-md-2"><?php esc_html_e('Plan','wprentals'); ?></div>
            <div class="col-md-2"><?php esc_html_e('Status','wprentals'); ?></div>
            <!-- //2023/2/12 デイユース開発 高橋（修正） -->
            <div class="col-md-2"><?php esc_html_e('Check-in','wprentals'); ?></div>
        ...
        $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            ...
            wprentals_pagination($book_selection->max_num_pages, $range =2);
                ...
                if($new_mess==1){
                    ...
                    // 2023/2/1 デイユース開発 高橋（修正）---
                    print '<h4 class="no_favorites">'.esc_html__( 'You don\'t have any reservation requests yet!','wprentals').'</h4>';
                }
