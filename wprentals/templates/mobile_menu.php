...
<div class="mobilewrapper-user" id="mobilewrapperuser">
    ...
    <!-- Right Sidebar-->
        ...
        if ( 0 != $current_user->ID  && is_user_logged_in() ) {
            ...
            // 2023/6/15 デイユース開発 高橋（追加）
            $current_lang = apply_filters( 'wpml_current_language', NULL );
            if('ja' == $current_lang){
                $owners_manual = get_template_directory_uri().'/pdf/[Japanese]DayDreamHub_Owners_Manual.pdf';
            }else{
                $owners_manual = get_template_directory_uri().'/pdf/[English]DayDreamHub_Owners_Manual.pdf';
            }
            ?>
            <ul class="user_mobile_menu_list">
                ...
                <!-- 2023/6/15 デイユース開発 高橋（追加-->
                <?php if( wpestate_check_user_level()){ ?>
                    <li><a href="<?php print esc_url($owners_manual);?>" ><i class="fas fa-book"></i> <?php esc_html_e('Listing Manual','wprentals');?></a></li>
                <?php } ?>
            ...
            <div class="login_form" id="login-div-mobile">
              ...
              <h3 class="widget-title-sidebar"  id="register-div-title-mobile">'.esc_html__( 'Register','wprentals').'</h3>
                <div class="login_form" id="register-div-mobile">
                    ...
                    <input type="text" name="user_firstname_register" id="user_firstname_register_wd_mobile" class="form-control" placeholder="'.esc_html__( 'Name','wprentals').'"/>

                    <input type="text" name="user_lastname_register" id="user_lastname_register_wd_mobile" class="form-control" placeholder="'.esc_html__( 'Surname','wprentals').'"/>';
            ...
            if($wp_estate_enable_user_phone=='yes'){
                print '<input type="text" name="user_phone_register" id="user_phone_register_wd_mobile" class="form-control" placeholder="'.esc_html__( '','wprentals').'" size="20" />';
                    ...
                    if($separate_users_status=='yes'){
                        ...
                        // <div class="radiolabel" for="acctype0">'.esc_html__('I am a customer','wprentals').'</div><br>
                        // <input type="radio" name="acc_type" id="acctype1" value="0" required>
                        // <div class="radiolabel" for="acctype1">'.esc_html__('I am a hotel manager','wprentals').'</div></div> ';
                    }
