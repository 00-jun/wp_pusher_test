...
<div class="col-md-12">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <p>
                   ...
                   <input type="text" id="title" class="form-control <?=($errors_class['title']) ? $errors_class['title'] : '';?>" value="<?php print esc_html($submit_title); ?>" size="20" name="wpestate_title" />
                </p>
        ...
        if($item_description_label==''){
            //  2023/2/16 デイユース開発 清水（修正）
            // $item_description_label=esc_html__('Room Description','wprentals');
            // 2023/6/20 デイユース開発 高橋（修正）
        ...
        <div class="col-md-12">
                    ...
                    <p>
                        ...
                        <?php
                            ...
                            if($item_rental_type==1){
                                echo '<span class="dashboard_red">*</span>';esc_html_e('Listing Categories','wprentals');
                            }
                        ?>
                        </label>
                    </p>
            ...
            <?php  if(   is_array($submission_page_fields) && in_array('prop_category_submit', $submission_page_fields)) { ?>
                ...
                <div class="col-md-3">
                   <p>
                        <label for="prop_category"><?php echo '<span class="dashboard_red">*</span>'; print esc_html($category_main_label);
                        // 2023/2/1 デイユース開発 高橋（追加）---
                        ...
                        <?php
                            if($errors_class['prop_category_submit']){
                                $error_show = $errors_class['prop_category_submit'];
                            }else{
                                $error_show = '';
                            }
                            $args=array(
                                    'class'       => 'select-submit2'.' '.$error_show,
                                    'hide_empty'  => false,
            ...
            <?php  if(   is_array($submission_page_fields) && in_array('prop_action_category_submit', $submission_page_fields)) { ?>
                ...
                <div class="col-md-3">
                     <p>
                        <label for="prop_action_category"> <?php echo '<span class="dashboard_red">*</span>'; print esc_html($category_second_label);?></label>
                        <!-- 2023/2/16 デイユース開発 清水（追加）----->
                        ...
                        <?php
                        if($errors_class['prop_action_category_submit']){
                            $error_show = $errors_class['prop_action_category_submit'];
                        }else{
                            $error_show = '';
                        }
                        $args=array(
            ...
            <?php  if(   is_array($submission_page_fields) && in_array('property_city_front', $submission_page_fields)) { ?>
                <div class="col-md-3" id="property_city_front_md">
                    ...
                    <p>
                        ...
                        <?php
                        if($errors_class['property_city_front']){
                            $error_show = $errors_class['property_city_front'];
                        }else{
                            $error_show = '';
                        }
                        ...
                        ?>
                            ...
                            <input type="text"   id="property_city_front<?php print esc_attr($wpestate_internal_search);?>" name="property_city_front" placeholder="<?php esc_html_e('Type the state name','wprentals');?>" value="<?php print esc_html($property_city);?>" class="advanced_select  form-control <?php print esc_html($error_show);?>">
                        <?php
                        }else{
                        ?>
        ...
        ?>
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <textarea  rows="4" id="property_description" name="property_description"  class="advanced_select  form-control" placeholder="<?php esc_html_e('Describe your room','wprentals');?>"><?php print esc_textarea($property_description); ?></textarea>
