        ...
        <div class="col-md-12">
            ...
            ?>
                <div class="col-md-3">
                    <p>
                        ...
                        <label for="property_address"><span class="dashboard_red">*</span><?php esc_html_e('Address','wprentals');?></label>
            ...
            ?>
                <div class="col-md-3">
                    <p>
                        <!-- 2023/2/1 デイユース開発 高橋 (追加) -->
                        <label for="property_zip"><span class="dashboard_red">*</span><?php esc_html_e('Zip','wprentals');?></label>
        ...
        if(is_array($submission_page_fields) &&
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 ">
                    <p>
                        <!-- 2023/2/1 デイユース開発 高橋 (追加) -->
                        <label for="property_state"><span class="dashboard_red">*</span><?php esc_html_e('State','wprentals');?></label>
