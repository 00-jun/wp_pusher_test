...
<div class="col-md-12" id="new_post2">
    ...
    ?>
        ...
        <div class="col-md-4 video_from_wrap"><!--クラス追加-->
            <p>
    ...
    ?>
        <!-- ▼2023/3/1 デイユース開発 清水（追加） -->
        <div class="col-md-4 video_id_wrap"><!--クラス追加-->
            <p>
                <!-- ▼2023/3/1 デイユース開発 清水（追加） -->
               <label for="embed_video_id"><?php esc_html_e('Video id: ','wprentals');?></label>
               <label for="embed_video_id"><?php esc_html_e('Please enter only the ID.','wprentals');?></label>
                <label for="embed_video_id"><?php esc_html_e('ex)dqwnaF5vsV0','wprentals');?></label>
