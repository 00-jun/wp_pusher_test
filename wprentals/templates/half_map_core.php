...
<div class="row <?php echo esc_attr($map_position); ?>">
    ...
    <div id="google_map_prop_list_sidebar" class="<?php echo esc_html('half_'. $wpestate_header_type); ?>">
        ...
        <!-- 2023/2/12 デイユース開発 高橋（追加） -->
        <span class="note_location"><?php esc_html_e('*You must enter a Location or the correct search results will not be displayed','wprentals')?></span>
