...
function wprentals_google_start_map(zoom_level){
    ...
    if ( document.getElementById('googleMap') ) {
        document.getElementById('googleMap').addEventListener('mousewheel', (event) => {scrollwhel();});
        document.getElementById('googleMap').addEventListener('DOMMouseScroll', (event) => {scrollwhel();});
    }
    if ( document.getElementById('google_map_prop_list') ) {
        document.getElementById('google_map_prop_list').addEventListener('mousewheel', (event) => {scrollwhel();});
        document.getElementById('google_map_prop_list').addEventListener('DOMMouseScroll', (event) => {scrollwhel();});
    }
