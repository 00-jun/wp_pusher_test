...
jQuery(document).ready(function ($) {
    ...
    if( parseInt( admin_google_vars.wprentals_map_type ) === 1){
        window.addEventListener('load', (event) => {wprentals_initialize_map_internal();});
    }else{
...
//    google.maps.event.addEventListener(document.getElementById('googleMap').getElementsByClassName("handlediv")[0], 'click', function () {
//        "use strict";
//        google.maps.event.trigger(map, "resize");
//    });
//}
